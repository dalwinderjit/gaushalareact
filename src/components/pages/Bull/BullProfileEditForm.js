...
export default class BullProfileEditForm extends Component {
                ...
                <div className="col-md-6">
                  ...
                  <table className="table">
                    ...
                    <tbody>
                      ...
                      <tr><td>Bull Sold</td><td>{values.sold===false?<button onClick={this.showSellBullModal} className="btn btn-success btn-sm">Sell Bull</button>:<button onClick={this.getSellBullDetail} className="btn btn-success btn-sm">Edit Sell Bull Detail</button>}  <input type="checkbox" checked={values.sold} id="sold" name="sold" onChange={handleChange}/></td></tr>
  ...
  getSellBullDetail=async ()=>{
    ...
    await this.props.bullProfile.sellBullModal.getSellAnimalDetail();
    //await this.props.bullProfile.sellAnimalModal.setSellAnimalDetail();
    this.props.bullProfile.sellBullModal.show();
  }
